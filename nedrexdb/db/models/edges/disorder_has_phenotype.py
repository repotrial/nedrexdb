...
class DisorderHasPhenotypeBase(models.MongoMixin):
    edge_type: str = "DisorderHasPhenotype"
    collection_name: str = "disorder_has_phenotype"
...
class DisorderHasPhenotype(_BaseModel, DisorderHasPhenotypeBase):
    class Config:
